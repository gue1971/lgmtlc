  ...
  "chapters": [
    {
      ...
      "items": [
        {
          "id": 1,
          "titleJa": "パラダイムシフトはいつ起こるか",
          "titleEn": "When Does a Paradigm Shift Happen?"
        },
        {
          "id": 2,
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "id": 42,
          "titleJa": "傍観者効果と倫理観のジレンマ（2）",
          "titleEn": ""
        },
        {
          "id": 43,
          "titleJa": "パンデミック下の差別と偏見",
          "titleEn": ""
        },
        {
          "id": 44,
          "titleJa": "多民族国家の民主主義（1）",
          "titleEn": ""
        },
        {
          "id": 45,
          "titleJa": "多民族国家の民主主義（2）",
          "titleEn": ""
        }
      ]
    },
    {
      "chapter": 10,
      "chapterTitle": "未来志向の探究課題",
      "items": [
        {
          "id": 46,
          "titleJa": "政府は出生率危機を解決できるか？",
          "titleEn": ""
        },
        {
          "id": 47,
          "titleJa": "政府は出生率に介入するべきか？",
          "titleEn": ""
        },
        {
          "id": 48,
          "titleJa": "地政学リスクの世界の舵を取る",
          "titleEn": ""
        },
        {
          "id": 49,
  ...
  "passages": {
    "1": {
      ...
      "paragraphs": [
        {
          "number": 1,
          "english": "The acceptance of a <red>paradigm</red> shift often requires the right balance of scientific <red>validation</red> and societal readiness.",
          "translation": "<red>パラダイムシフト</red>の受容には、多くの場合、科学的な<red>承認</red>と社会の準備が整っていることの、適正な釣り合いが必要である。"
        },
        {
          "number": 2,
          "english": "One historical example of this balance is the <red>transition</red> from the <red>geocentric</red> to the <red>heliocentric</red> model. For a long time, the sun was believed to <red>revolve</red> around Earth. However, in 1543, Nicolaus Copernicus proposed that the Earth revolves around the Sun. Over a century later, this theory gained greater credibility thanks to Isaac Newton’s discovery of universal <red>gravitation</red> in 1665, which seemed to <red>confirm</red> Copernicus’ radical ideas. However, people were initially hesitant to <red>abandon</red> foundational assumptions about the Earth’s place in the universe, which connected to everything from calendars based on the sun’s movements to stars used for navigation. Over time, human <red>curiosity</red> and Newton’s ideas helped the heliocentric model become the dominant one.",
          "translation": "この釣り合いの歴史上の一例に、<red>地球中心</red>説から<red>太陽中心</red>説への<red>移行</red>がある。長い間、太陽は地球の周りを<red>回転する</red>と信じられてきた。しかし、1543年、ニコラウス・コペルニクスは地球が太陽の周りを回転すると提唱した。1世紀あまりのち、この理論は、アイザック・ニュートンの1665年における万有<red>引力</red>の発見のおかげで、大きく信頼性を増した。その発見はコペルニクスの根本にかかわる考えを<red>裏付ける</red>ように思われたのだ。ところが、人々は初めのうち、宇宙の中の地球の位置に関する基本的な仮説を<red>放棄する</red>ことをためらった。それらの仮説は、太陽の動きに基づく暦から、航海に利用された星々まで、あらゆるものと結びついていたのだ。時がたつにつれて、人間の<red>好奇心</red>とニュートンの考えは、太陽中心説が有力説となるのに役立ったのである。"
        },
        {
          "number": 3,
          "english": "Similarly, the <red>advent</red> of Gutenberg’s printing press and the internet marked <red>significant</red> paradigm shifts in how information could be shared. Both enabled the storage, sharing, and preservation of vast amounts of information and were rapidly <red>embraced</red> by the general public. The printing press led to a <red>surge</red> in <red>literacy</red> rates in its day while the internet allowed for <red>instantaneous</red> international communication.",
          "translation": "同様に、グーテンベルクの印刷機やインターネットの<red>出現</red>は、どのように情報が共有され得るかにおいて、<red>重要な</red>パラダイムシフトとなった。どちらも膨大な量の情報の保管、共有、そして保存を可能にし、さらにたちまち一般大衆に<red>受け入れられた</red>。印刷機は当時の<red>識字</red>率の<red>急上昇</red>をもたらし、一方インターネットは<red>瞬時</red>の国際通信を可能にしたのである。"
        },
        {
          "number": 4,
          "english": "Unlike the heliocentric theory, technologies for sharing information did not contradict a single <red>perspective</red>, but instead empowered those who could harness the technology to dramatically expand their reach. Both the printing press and the internet show that, given the right conditions, paradigm shifts can reshape society as we know it, within just a few decades of the invention.",
          "translation": "太陽中心説と異なり、情報共有のための技術は、1つの<red>視点</red>を否定することはなく、その代わりに、その技術を利用することができる人々が手の届く範囲を劇的に広げることを可能にした。印刷機とインターネットのどちらも示しているのは、適切な条件が整っていれば、その発明のわずか数十年以内に、パラダイムシフトは私たちが知っている社会を、作り変えることができるということである。"
        }
      ],
      "phrases": [
        {
    ...
    "4": {
      ...
      "paragraphs": [
        ...
        },
        {
          ...
          "translation": "その後，2015年1月に，「ママは正しかった―体が冷えると風邪を引く」というような見出しが，真面目な新聞や雑誌に登場した。エレン・F・フォックスマン率いるイェール大学のチームが，「ライノウイルスに対する<red>生得的な</red>免疫<red>反応</red>は，<red>深部</red>体温と比べ，体温が低い状態の時に<red>弱められる</red>」ことを発見したのだ。言い換えれば，鼻の中に風邪のウイルスが存在するかどうかは温度には依存しないが，それに対する免疫反応は温度に左右される。つまり体が冷えると風邪を引く可能性が実際に高くなるかもしれない，ということになる。もっと言えば，鼻がすでにウイルスに感染していたならば，風邪を発症する可能性が高いということなのである。（続）"
        }
      ],
      "phrases": [
        {
